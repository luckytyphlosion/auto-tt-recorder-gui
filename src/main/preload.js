...
contextBridge.exposeInMainWorld("api", {
  ...
  isFileReadableAndHasCorrectExtension_alsoGetExtension: (filename, expectedExtensionsMinusDot) => ipcRenderer.invoke("is-file-readable-and-has-correct-extension", filename, expectedExtensionsMinusDot),
