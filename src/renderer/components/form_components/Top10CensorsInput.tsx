      ...
      <div className="grid-contents">
        ...
        <div className="start-label-contents">
          <p className="form-input-notes">
            List IDs of players to replace on the Top 10 with the default Player Mii, separated by spaces <FormInputNotesAutoTTRecArgName>chadsoft-cache-expiry</FormInputNotesAutoTTRecArgName>.<br/>
